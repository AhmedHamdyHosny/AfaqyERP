...
{
    public class ApiDeliveryDetailsController : BaseApiController<DeliveryDetails>
    {
    ...
    public class ApiDeliveryDetailsViewController : BaseApiController<DeliveryDetailsView>
    {
