...
{
    public class ModelTypeModel<TModel> : GenericModel<TModel> where TModel : class
    {
        const string ApiRoute = "api/ApiModelType/";
        private static string ApiUrl = SiteConfig.ApiUrl;
        public ModelTypeModel() : base(ApiUrl, ApiRoute)
        {
        }
