...
namespace Afaqy_Store.Models
{
    ...
    public class SIMCardStatusViewModel : SIMCardStatus
    {
    ...
    public class SIMCardStatusIndexViewModel : SIMCardStatus
    {

    }
    public class SIMCardStatusDetailsViewModel : SIMCardStatusViewModel
    {

    }

    [Bind(Include = "SIMCardStatusId,SIMCardStatusName_en,SIMCardStatusName_ar,IsBlock,CreateUserId,CreateDate")]
